<template>
  <div>
    ...
    <div class="list">
      <el-table
        :data="materialInfo.slice((currentPage-1)*pagesize,currentPage*pagesize)"
        style="width: 100%"
        highlight-current-row
        border
        @current-change="handleCurrentsChange"
      >
        <el-table-column label="项目编码" prop="materialNum"></el-table-column>

        <el-table-column label="项目名称" prop="materialName"></el-table-column>

        <el-table-column label="项目申请时间" prop="materialPostTime"></el-table-column>

        <el-table-column label="项目编码通过时间" prop="materialPassTime"></el-table-column>
    ...
    rejected(){
        ...
        this.$axios
          .put("/materialState", {
            ...
            materialState: _this.bohuidata.materialState,
    ...
    shenpigo(){
      // this.shenpi.materialState = "审批通过";
        ...
        this.$axios
          .put("/materialState", {
             id : _this.shenpi.id,
            materialState: _this.shenpi.materialState
          })
          .then(res => {
            if (res.data.code === 200) {
              this.$message("审批通过成功");
