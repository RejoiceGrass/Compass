<template>
  <div>
    ...
    <div class="list">
      ...
      >
        <el-table-column label="项目编码" prop="needPlanNum"></el-table-column>

        <el-table-column label="项目内部编码" prop="materialNum"></el-table-column>
        ...
        <el-table-column label="预估价格" prop="price"></el-table-column>

        <el-table-column label="项目总价" prop="num_price"></el-table-column>
