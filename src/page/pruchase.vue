<template>
  <div>
    <div class="topButton">
      <el-button size="mini" type="primary" @click="bohui()">申请项目</el-button>
    </div>
    <div class="list">
      <el-table
      ...
      >
        <el-table-column label="项目编码编码" prop="needPlanNum"></el-table-column>

        <el-table-column label="项目名称" prop="materialName"></el-table-column>

        <el-table-column label="项目人数" prop="num"></el-table-column>

        <el-table-column label="申请时间" prop="materialPassTime"></el-table-column>

        <el-table-column label="项目预估价格" prop="price"></el-table-column>
        <el-table-column label="项目总价格" prop="num_price"></el-table-column>

        <el-table-column label="状态" prop="needPlanState"></el-table-column>
        <el-table-column label="审批人" prop="buyer"></el-table-column>
